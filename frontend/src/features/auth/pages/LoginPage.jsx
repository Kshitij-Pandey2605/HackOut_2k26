...
export const LoginPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/85 to-white/40 lg:to-transparent lg:w-[56%] pointer-events-none z-0" />
      ...
      {/* ========================================================================= */}
      {/* MAIN CONTENT SPLIT LAYOUT (NON-SCROLLABLE FIT)                            */}
      {/* ========================================================================= */}
      <main className="max-w-[1536px] w-full mx-auto px-6 sm:px-12 py-2 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-20 min-h-0">
        ...
        {/* ======================================================================= */}
        <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center space-y-4 text-slate-900 pr-0 lg:pr-6 relative">
          
          {/* Floating script over the industrial chimneys */}
          <div className="absolute right-6 top-2 hidden xl:block pointer-events-none text-right z-10">
            <span className="font-serif italic text-slate-700 text-xs font-bold block leading-tight drop-shadow-sm">
              Cleaner<br />Industries<br />Brighter<br />Tomorrows
            </span>
            <div className="w-12 h-0.5 bg-[#0e9f6e] rounded-full ml-auto mt-0.5" />
          </div>

          {/* Floating Badge on Tanks: People / Planet / Progress */}
          <div className="absolute right-8 bottom-32 hidden md:block z-10">
            <div className="bg-white/90 backdrop-blur-md border border-white/70 rounded-2xl p-2.5 shadow-md flex items-center gap-2">
        ...
        {/* ======================================================================= */}
        {/* RIGHT COLUMN: LOGIN FORM CARD (COMPACT VERTICAL SIZING)                 */}
        {/* ======================================================================= */}
        <div className="lg:col-span-6 xl:col-span-6 flex items-center justify-center lg:justify-end relative">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 shadow-[0_16px_50px_rgba(0,0,0,0.10)] p-6 sm:p-7 max-w-md w-full space-y-4 relative z-10">
            ...
            {/* Floating Foliage & Cursive Script */}
            <div className="absolute -top-10 right-2 hidden sm:flex items-center gap-2 pointer-events-none z-20">
              <div className="text-right">
                <span className="font-serif italic text-[11px] font-bold text-slate-700 block leading-tight">
                  Real<br />Solutions<br />for a<br />
                  <span className="text-[#0e6245]">Healthier</span><br />
                  Planet
                </span>
                <div className="w-10 h-0.5 bg-[#0e6245] rounded-full ml-auto mt-0.5" />
              </div>
              <div className="w-10 h-10 text-[#10b981] opacity-90">
                <Leaf className="w-full h-full fill-[#10b981]/20 -rotate-12" />
              </div>
            </div>
            ...
            {/* Dual Social Auth Buttons: Google & Microsoft */}
            <div className="grid grid-cols-2 gap-2">
              ...
              <button 
                type="button"
                onClick={() => {
                  login({ email: 'microsoft.user@example.com', name: 'Microsoft User' }, 'mock_token', USER_ROLES.SUPPLIER);
                  navigate('/supplier/dashboard');
                }}
                className="border border-slate-200 hover:bg-slate-50 text-slate-700 text-[11px] font-semibold py-2 px-2.5 rounded-xl flex items-center justify-center gap-1.5 transition-colors shadow-xs"
              >
          ...
          {/* Green leaf in bottom right corner */}
          <div className="absolute -bottom-8 -right-8 w-32 h-32 pointer-events-none opacity-30 z-0">
            <Leaf className="w-full h-full text-[#10b981] fill-[#10b981]/20 rotate-45" />
          </div>
